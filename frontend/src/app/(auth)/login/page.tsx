        ...
        onSuccess: async (tokenResponse) => {
            try {
                ...
                if (res.ok && data.access) {
                    ...
                    login(data.access, rememberMe);
                } else if (res.ok && data.key) {
                    // Token auth fallback
                    login(data.key, rememberMe);
                } else {
    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="hidden lg:flex w-1/2 flex-col justify-between p-12 bg-surface-container-low">
                ...
                <div className="mb-12">
                    <h2 className="text-5xl font-display font-medium text-primary leading-tight mb-8">Your Health,<br />Journaled.</h2>
                ...
                <div className="bg-surface-container-lowest p-6 rounded-3xl shadow-[0_20px_40px_rgba(11,54,29,0.06)] border border-outline-variant/15 w-80">
                    <p className="font-body text-on-surface-variant text-sm mb-2 uppercase tracking-wider font-semibold">Daily Insight</p>
                    <p className="font-display text-primary text-xl font-medium mb-1">&quot;Your protein intake today is 15% higher than average, fueling your morning recovery perfectly.&quot;</p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-surface">
                <div className="w-full max-w-md">
                    <h3 className="text-3xl font-display font-semibold text-primary mb-2">Welcome Back</h3>
                    <p className="text-on-surface-variant mb-10 font-body">Log in to continue your wellness journey.</p>
                    ...
                    <form className="space-y-6">
                        ...
                        <div>
                            <label className="block font-body text-on-surface-variant mb-2 text-sm flex justify-between">
                                <span>Password</span>
                                <Link href="#" className="text-primary hover:text-primary-container transition-colors">Forgot Password?</Link>
                            </label>
                        ...
                        <div className="flex items-center gap-2">
                            <input
                                ...
                                className="rounded text-primary focus:ring-primary/40 focus:ring-offset-0 bg-surface-container-low border-outline-variant/30"
                            />
                            <label htmlFor="rememberMe" className="text-sm font-body text-on-surface-variant cursor-pointer">
                    ...
                    <div className="mt-12 text-center">
                        <p className="font-body text-on-surface-variant">Don&apos;t have an account? <Link href="/register" className="text-secondary-dim font-semibold hover:text-secondary transition-colors underline underline-offset-4 decoration-2">Sign Up</Link></p>
                    </div>
                </div>
            </div>
        </div>
